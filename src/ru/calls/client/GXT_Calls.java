 ...
 */
public class GXT_Calls implements EntryPoint {
	/**
	...
	public void onModuleLoad() {
		...
		RootPanel.get("r1c1").add(nameField);
		RootPanel.get("r1c2").add(sendButton);
		...
		RootPanel.get("r1c2").add(textButton);
		...
		//-------------------------------------------------------------------------
		RootPanel.get("gxtTable").add(new GXTTable());		

		//-------------------------------------------------------------------------
		RootPanel.get("callsTable").add(new CallsTable());		
	}
}
