...
class SortedByName2 implements Comparator<Post>
{
...
public class CallsServiceImpl extends RemoteServiceServlet implements CallsService
{
	...
	{
		logger.warning("CallsServiceImpl: PagingLoadResult");
		...
		if (config.getSortInfo().size() > 0) {
			...
			if ((sortField != null) && sortField.equalsIgnoreCase("username") && 
				...
				Arrays.sort(data, new SortedByName2());
				sort_fld = sortField;
...
//							return p1.getUsername().compareTo(p2.getUsername());
	...
	{
		logger.warning("CallsServiceImpl: loadPosts#1");
